const inputBox = document.querySelector("input");
    ...
    function addTodo(){
        ...
        todoList.push({todo:inputBox.value,color:strUser==1?"red":(strUser==2)?"#FFBF00":"green"});
    ...
    function showTodos(){
        ...
        todoList.map((element,index)=>{
          // console.log(element);
          // console.log(index);
            todos+=`<li style=background:${element.color};color:white;>${element.todo}<span class="icon" onclick="deleteTask(${index})"><i class="bi bi-dash-circle"></i></span></li>`;
        })
